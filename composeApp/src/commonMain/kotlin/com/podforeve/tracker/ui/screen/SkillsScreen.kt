...
@Composable
private fun SkillsContent(state: UiState<List<SkillQueueEntry>>, onRefresh: () -> Unit) {
    Scaffold(
...
@Composable
private fun SkillsSuccessContent(entries: List<SkillQueueEntry>, onRefresh: () -> Unit) {
