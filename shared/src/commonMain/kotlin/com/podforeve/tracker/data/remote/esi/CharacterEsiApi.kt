...
class CharacterEsiApi(
    ...
    suspend fun fetchWalletBalance(characterId: Long): Double = esiClient.get("$ESI_BASE/v1/characters/$characterId/wallet/").body()

    fun portraitUrl(characterId: Long, size: Int = 128): String = "$IMAGE_BASE/characters/$characterId/portrait?size=$size"
